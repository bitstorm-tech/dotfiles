...
vim.keymap.set('n', '<leader>Tt', ':Telescope colorscheme<cr>', { desc = 'Open colorscheme' })
...
vim.keymap.set('n', '<leader>Ts', ':ThemeSystemSyncToggle<cr>', { desc = 'Toggle system theme sync' })
