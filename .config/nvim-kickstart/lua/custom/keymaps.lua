...
vim.keymap.set('n', '<space>ba', ':CloseAllBuffers<cr>', { desc = 'Close all buffers' })
vim.keymap.set('n', '<C-s>', ':wa<cr>', { desc = 'Save all' })
vim.keymap.set('n', 'ss', ':wa<cr>', { desc = 'Save all' })
...
vim.keymap.set('i', 'jj', '<Esc><Esc>', { desc = 'Exit Insert mode' })
vim.keymap.set('i', 'ss', '<Esc>:wa<cr>', { desc = 'Save all' })
