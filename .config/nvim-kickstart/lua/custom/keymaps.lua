...
vim.keymap.set('n', '<C-h>', ':NvimTreeFindFileToggle<cr>', { desc = 'Toggle NvimTree' })
...
vim.keymap.set('n', '<D-j>', ':bnext<cr>', { desc = 'Goto next buffer' })
vim.keymap.set('n', '<D-k>', ':bprevious<cr>', { desc = 'Goto next buffer' })
